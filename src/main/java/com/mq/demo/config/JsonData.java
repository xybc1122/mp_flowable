...
public class JsonData {
    ...
    public static ResponseBase setResultError(String msg) {
        return setResult(JsonDataConfig.HTTP_RES_CODE, msg, null);
    }

    // 返回错误 ，传msg 跟data
    public static ResponseBase setResultError(String msg, Object data) {
        return setResult(JsonDataConfig.HTTP_RES_CODE, msg, data);
    }
    ...
    public static ResponseBase setResultSuccess(Object data) {
        return setResult(JsonDataConfig.HTTP_RES_CODE_200, JsonDataConfig.HTTP_RES_CODE_200_VALUE, data);
    }

    // 返回成功 参数空
    public static ResponseBase setResultSuccess() {
        return setResult(JsonDataConfig.HTTP_RES_CODE_200, JsonDataConfig.HTTP_RES_CODE_200_VALUE, null);
    }

    // 返回成功 ，可以传msg
    public static ResponseBase setResultSuccess(String msg) {
        return setResult(JsonDataConfig.HTTP_RES_CODE_200, msg, null);
    }

    // 返回成功 ，可以传msg ,data
    public static ResponseBase setResultSuccess(String msg, Object data) {
        return setResult(JsonDataConfig.HTTP_RES_CODE_200, msg, data);
    }

    // 返回成功 ，可以传msg ,type
    public static ResponseBase setResultTypeSuccess(String msg, String type) {
        return setResultType(JsonDataConfig.HTTP_RES_CODE_200, msg, type);
    }

    // 返回错误 ，可以传msg,type
    public static ResponseBase setResultTypeError(String msg, String type) {
        return setResultType(JsonDataConfig.HTTP_RES_CODE, msg, type);
    }
